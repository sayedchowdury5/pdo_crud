...
<body style="background-color:lightblue;">
    <div class="container mt-3 mb-3" style="background-color:white; border: 2px dashed green;">
        ...
        <div>
            <h3 class="text-center">All Records for Daily Shopping</h3>
            ...
            <h5 class="text-info">Date: <?php echo $first_date; ?> - <?php echo $last_date; ?> / <span>Total Spent: <?php echo $all_item_round_total_price; ?></span></h5>
        </div><hr>
